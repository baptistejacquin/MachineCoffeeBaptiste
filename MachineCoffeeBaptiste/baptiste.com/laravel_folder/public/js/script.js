...
//EXPRESSO
    $("#btnExpresso").click(function () {
        ...
        else if ($srcImageBoisson === "image_machine/Vue1-assets/Bouton_Expresso_etat3.png") {
            $("#Alerte").html("La boisson n'est pas disponible");
            $("#PrixBoisson").html("0 €");
        }
        //Sinon
        else {
...
//DOUBLE EXPRESSO
    $("#btnDouble_expresso").click(function () {
        ...
        else if ($srcImageBoisson === "image_machine/Vue1-assets/Bouton_Double_expresso_etat3.png") {
            $("#Alerte").html("La boisson n'est pas disponible");
            $("#PrixBoisson").html("0 €");
        }
        else {
...
//CAFE LONG
    $("#btncafe_long").click(function () {
        ...
        else if ($srcImageBoisson === "image_machine/Vue1-assets/Bouton_cafe_long_etat3.png") {
            $("#Alerte").html("La boisson n'est pas disponible");
            $("#PrixBoisson").html("0 €");
        }
        else {
...
//CAPPUCCINO
    $("#btncappuccino").click(function () {
        ...
        else if ($srcImageBoisson === "image_machine/Vue1-assets/Bouton_cappuccino_etat3.png") {
            $("#Alerte").html("La boisson n'est pas disponible");
            $("#PrixBoisson").html("0 €");
        }
        else {
...
//Appuyer sur les boutons + et - pour régler la quantité de sucre
    $("#btnPluSucre").click(function () {
        let current = parseInt($('#selecsugar').val());
        if (current < stockSucre) {
            addSugar();
            $(this).attr('src', 'image_machine/Vue1-assets/Bouton_plus_etat2.png');
            $(this).attr('src', 'image_machine/Vue1-assets/Bouton_plus_etat2.png');
            $('#selecsugar').val(current + 1);
        }
...
//Lorsqu'on click sur "return" 
    $("#boutonRetour").click(function () {
        ...
        else if ($srcImageBoisson4 === "image_machine/Vue1-assets/Bouton_cappuccino_etat2.png") {
            remove("cappuccino");
            $('#formulaireVente').submit();
        } else {
            remove("Expresso");
